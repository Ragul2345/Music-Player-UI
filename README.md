...
The goal of this project is to practice frontend development and UI/UX concepts, not real audio streaming.
...
* No streaming APIs are used  
* Playback is visually simulated for UI demonstration purposes  
